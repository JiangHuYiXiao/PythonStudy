...
# print(os.getcwd())          # F:\Python_study\Python基础&并发编程\day19
#
#
# # # 2、os.chdir 改变当前脚本的工作目录
# os.chdir(r'F:\Python_study\Python基础&并发编程\day18')  #r取消转义
...
# print(os.pardir)            # ..
# os.chdir('F:\Python_study\Python基础&并发编程\day19')
# print(os.getcwd())          # F:\Python_study\Python基础&并发编程\day19
# os.chdir('..')
# print(os.getcwd())          # F:\Python_study\Python基础&并发编程
#
...
# print(os.listdir(r'F:\Python_study'))        # ['.git', '.idea', 'day1', 'day10', 'day11', 'day12', 'day13', 'day14', 'day15', 'day16', 'day17', 'day18', 'day19', 'day2', 'day3', 'day4', 'day5', 'day6', 'day7', 'day8', 'day9', 'README.md', '_config.yml']
#
# # 10、os.stat()获取文件信息、目录信息
# print(os.stat(r'F:\Python_study\Python基础&并发编程\day19'))         # os.stat_result(st_mode=16895, st_ino=5348024557505658, st_dev=4021814972, st_nlink=1, st_uid=0, st_gid=0, st_size=4096, st_atime=1545987267, st_mtime=1545987267, st_ctime=1545042380)
# # stat 结构:
#
# # st_mode: inode 保护模式
# # st_ino: inode 节点号。
